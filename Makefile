...
pkgdatadir = $(datadir)/g722_1
pkglibdir = $(libdir)/g722_1
pkgincludedir = $(includedir)/g722_1
top_builddir = .
...
DIST_COMMON = README $(am__configure_deps) $(srcdir)/Makefile.am \
	$(srcdir)/Makefile.in $(srcdir)/g722_1.pc.in \
	$(srcdir)/g722_1.spec.in $(top_srcdir)/configure AUTHORS \
...
CONFIG_CLEAN_FILES = g722_1.pc g722_1.spec
...
ACLOCAL = ${SHELL} /home/ebuu/libg722_1/config/missing --run aclocal-1.9
AMDEP_FALSE = #
AMDEP_TRUE = 
AMTAR = ${SHELL} /home/ebuu/libg722_1/config/missing --run tar
AR = ar
AUTOCONF = ${SHELL} /home/ebuu/libg722_1/config/missing --run autoconf
AUTOHEADER = ${SHELL} /home/ebuu/libg722_1/config/missing --run autoheader
AUTOMAKE = ${SHELL} /home/ebuu/libg722_1/config/missing --run automake-1.9
AWK = gawk
CC = gcc
CCDEPMODE = depmode=gcc3
CC_FOR_BUILD = $(CC)
CFLAGS = -g -O2
COMP_VENDOR_CFLAGS = -DNDEBUG -std=gnu99 -ffast-math -Wall -Wunused-variable -Wwrite-strings -Wstrict-prototypes -Wmissing-prototypes
COMP_VENDOR_LDFLAGS = 
COND_DOC_FALSE = 
COND_DOC_TRUE = #
COND_MMX_FALSE = 
...
INSERT_INTTYPES_HEADER = #include <inttypes.h>
INSERT_MATH_HEADER = #include <math.h>
INSERT_STDINT_HEADER = #include <stdint.h>
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /home/ebuu/libg722_1/config/missing --run makeinfo
OBJEXT = o
PACKAGE = g722_1
PACKAGE_BUGREPORT = 
PACKAGE_NAME = 
...
infodir = ${prefix}/info
install_sh = /home/ebuu/libg722_1/config/install-sh
...
prefix = /home/ebuu/mediaserver-trunk/staticdeps/
...
g722_1.pc: $(top_builddir)/config.status $(srcdir)/g722_1.pc.in
...
rpm-build:
	...
	rm -f rpm/SPECS/*
	rm -f rpm/SRPMS/*
	rpm -ta --sign g722_1-0.0.1.tar.gz

bump.rpm.release: g722_1.spec
	VERSION="x"; \
	test -f $(srcdir)/rpm.release && . $(srcdir)/rpm.release; \
	NEXT_RELEASE=0; \
	test "$$VERSION" = "0.0.1" && NEXT_RELEASE="$$RELEASE"; \
	RELEASE=`expr $$NEXT_RELEASE + 1`; \
	echo "VERSION=0.0.1" >$(srcdir)/rpm.release; \
